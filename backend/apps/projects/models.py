...
class Project(models.Model):
    ...
    supported_languages = models.JSONField(default=list, help_text="A list of language codes for the generated app.")
    requirements_document = models.FileField(upload_to='requirements/', blank=True, null=True, help_text="User-uploaded requirements document.")
    initial_prompt = models.TextField(blank=True, null=True, help_text="Initial user prompt for 'Zero-Touch' creation.")
